# -*- coding: utf-8 -*-
"""
Created on Tue Dec 01 16:24:26 2015
...
class SvmModel:
    ...
    def train_svm_model(self):
        ...
        # Initialize a SVM classifier with a kernel
        self.svm_model = svm.SVC(gamma=0.0001,  C = 100)
        ...
        self.svm_model = self.svm_model.fit( train_smote[self.train_cols], train_smote[0])
...
###################################################################
    ...
    def test_svm_model(self):
        ...
        result = self.svm_model.predict(self.x_test)
